...
battery = BatteryWidget(panel, '<inactive>{b[0][icon]} <normal>{b[0][status][0]}{b[0][percent]} <inactive>({b[0][time]})')
battery2 = BatteryWidget(panel, '<inactive>{b[1][icon]} <normal>{b[1][status][0]}{b[1][percent]} <inactive>({b[1][time]})')
